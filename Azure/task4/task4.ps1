...
$gitrepo2="https://github.com/havronskyi/StudentsList.git"

# Unique web app name
$webappname1="StudentList$(Get-Random)"
$webappname2="StudentList$(Get-Random)"
$webappname1SP=$webappname1 + 'SP'
$webappname2SP=$webappname2 + 'SP'

# Creates a resource group
#$rg = New-AzureRmResourceGroup -Name $resourceGroup -Location $location
$rg = Get-AzureRmResourceGroup -Name $resourceGroup -ErrorAction Ignore
if ( ! $rg ) {
  $rg = New-AzureRmResourceGroup -Name $resourceGroup -Location $location
}
...
if ( ! $(Get-AzureRmAppServicePlan -ResourceGroupName $rg.ResourceGroupName -Name $webappname1SP -ErrorAction Ignore)) {
  New-AzureRmAppServicePlan -Name $webappname1SP -ResourceGroupName $rg.ResourceGroupName -Location $location -Tier Free
}
if ( ! $(Get-AzureRmAppServicePlan -ResourceGroupName $rg.ResourceGroupName -Name $webappname2SP -ErrorAction Ignore)) {
  New-AzureRmAppServicePlan -Name $webappname2SP -ResourceGroupName $rg.ResourceGroupName -Location $location -Tier Free
}
#New-AzureRmAppServicePlan -Name $webappname1SP -Location $location -ResourceGroupName $rg.ResourceGroupName -Tier Free
#New-AzureRmAppServicePlan -Name $webappname2SP -Location $location -ResourceGroupName $rg.ResourceGroupName -Tier Free

New-AzureRmAppServicePlan -Name $webappname2'SP' -Location $location -ResourceGroupName $rg.ResourceGroupName -Tier Free

# Creates a web app
#$webapp1 = New-AzureRmWebApp -ResourceGroupName $rg.ResourceGroupName -Name $webappname1 -Location $location -AppServicePlan $webappname1SP
#$webapp2 = New-AzureRmWebApp -ResourceGroupName $rg.ResourceGroupName -Name $webappname2 -Location $location -AppServicePlan $webappname2SP

$webapp1 = Get-AzureRmWebApp -ResourceGroupName $rg.ResourceGroupName -Name $webappname1 -ErrorAction Ignore
if( ! $webapp1 ) {
  $webapp1 = New-AzureRmWebApp -ResourceGroupName $rg.ResourceGroupName -Name $webappname1 -Location $location -AppServicePlan $webappname1SP
}
$webapp2 = Get-AzureRmWebApp -ResourceGroupName $rg.ResourceGroupName -Name $webappname2
if( ! $webapp2 ) {
  $webapp2 = New-AzureRmWebApp -ResourceGroupName $rg.ResourceGroupName -Name $webappname2 -Location $location -AppServicePlan $webappname2SP
}
...
$vnet = Get-AzureRmVirtualNetwork -ResourceGroupName $rg.ResourceGroupName -Name $AGWVnet -ErrorAction Ignore
if( ! $vnet ) {
  $vnet = New-AzureRmVirtualNetwork -Name $AGWVnet -ResourceGroupName $rg.ResourceGroupName -Location $location -AddressPrefix $AdPrVN -Subnet $subnet
}
...
$pip = Get-AzureRmPublicIpAddress -ResourceGroupName $rg.ResourceGroupName -Name $publicIP -ErrorAction Ignore
if( ! $pip ) {
       $pip = New-AzureRmPublicIpAddress -ResourceGroupName $rg.ResourceGroupName -Location $location  -Name $publicIP -AllocationMethod Dynamic
}
